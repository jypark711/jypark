...
print ("5. 1==1 or 2!=1 =%s" % str(True and (1 ==1)))
...
print ("17. not('testing' == 'testing' and 'Zed'=='Cool Guy') =%s" %(('testing'=='testing') and not ('Zed'=='Cool Guy')))
print ("18. 1==1 and not('testing'==1 or 1==0) =%s" % (not('testing'==1 or 1==0)))
